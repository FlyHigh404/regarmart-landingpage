...
<template>
                  ...
                  <div class="mt-3">
                    ...
                                        <div class="text-sm flex flex-wrap gap-4 text-black">
                                             <label class="flex items-center space-x-2 cursor-pointer">
                                                  <input type="radio" name="tipe" value="normal"
                          v-model="localFilterParams.isPromoFilter" class="text-green-600 focus:ring-green-500" />
                                                  <span class="font-semibold">Harga Normal</span>
                                               </label>
                                             <label class="flex items-center space-x-2 cursor-pointer">
                                                  <input type="radio" name="tipe" value="promo"
                          v-model="localFilterParams.isPromoFilter" class="text-green-600 focus:ring-green-500" />
        ...
        <div class="flex flex-wrap items-center gap-2 mt-3 md:mt-5 lg:mt-0 order-2 lg:order-1">
          ...
          <div class="relative">
            ...
            <div v-if="showHargaMenu"
              ...
              <button class="block w-full text-left px-3 py-2 text-sm hover:bg-gray-100" @click="setSort('harga-asc')">
                Termurah → Termahal
                <span v-if="filterParams.sortBy === 'harga-asc'" class="text-[#26A81D] ml-1">✓</span>
              </button>
              <button class="block w-full text-left px-3 py-2 text-sm hover:bg-gray-100" @click="setSort('harga-desc')">
                Termahal → Termurah
      ...
      <div class="flex gap-8 items-start">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 flex-1">
          ...
          <div v-if="isLoading" class="col-span-full text-center py-10">
            <svg class="animate-spin h-8 w-8 text-[#26A81D] mx-auto mb-3" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24">
  ...
  <transition name="fade">
    <div v-if="isQuickViewOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm"
