                    ...
                    <div v-for="(product, index) in [...bestSellers, ...bestSellers]" :key="`${product.id}-${index}`"
                      ...
                      <div class="p-3 sm:p-4 flex flex-col flex-grow">
                        ...
                        <div class="space-y-2 mt-auto">
                          <a :href="getWhatsappLink(product.name)" target="_blank"
                            class="flex gap-1 items-center justify-center bg-gradient-to-br from-[#6EC568] to-[#26A81D] text-white py-2 rounded-[10px] text-center transition-colors text-[11px] sm:text-[12px] hover:opacity-90">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 20 21"
                              fill="none">
                              <path
                          ...
                          <button @click="openQuickView(product.imageUrl || '/susu.png')"
