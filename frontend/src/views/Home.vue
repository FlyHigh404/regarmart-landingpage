    ...
    <section id="hero" class="pt-5 sm:pt-10">
      <div class="container mx-auto">
        ...
        <p class="text-[#6D706E] text-center text-sm sm:text-[18px] mx-auto max-w-2xl">
          ...
          <span class="font-bold">Regar Mart</span> siapin dengan <span class="font-bold">packing rapi</span> dan kirim langsung ke rumahmu.
        </p>
              ...
              <div class="p-5 pl-7 bg-white rounded-xl shadow-md border border-gray-100">
                ...
                <ul class="text-sm text-semibold space-y-4">
                  <li class="flex justify-between items-center text-gray-700 cursor-pointer transition-colors">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                  </li>
                  <li class="flex justify-between items-center text-gray-700 cursor-pointer transition-colors">
            ...
            <div class="lg:col-span-2 flex flex-col py-2">
              <div class="flex justify-between items-center mb-4">
                ...
                <div class="hidden sm:flex space-x-1">
                  <button class="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center border border-gray-300 rounded-[6px] text-black hover:bg-gray-100 transition-colors text-sm">
                    &lt;
                  </button>
                  <button class="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center border border-gray-300 rounded-[6px] text-black hover:bg-gray-100 transition-colors text-sm">
                    &gt;
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-6 flex-grow">
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300 flex flex-col">
    ...
    <section id="keunggulan" class="pt-10 sm:pt-20">
      <div class="container mx-auto text-center">
        ...
        <p class="text-[#6D706E] text-sm sm:text-[18px] mx-auto mb-6 sm:mb-8 max-w-3xl">
          Regar Mart hadir untuk memberikan <span class="font-bold">pengalaman belanja yang lebih baik. </span>Kami menawarkan <br class="hidden sm:block" />
          <span class="font-bold">keunggulan </span>yang membuat setiap transaksi <span class="font-bold">lebih mudah, hemat, dan terpercaya.</span>
        </p>
        ...
        <div class="text-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          <div
            ...
            <div class="w-full h-48 overflow-hidden"> <img src="/keunggulan.png" alt="Sustainability & Environmental Impact"
            ...
            <div class="px-5 py-6 sm:px-9 sm:py-8 flex flex-col flex-grow">
              ...
              <p class="text-[13px] sm:text-[14px] text-gray-700 text-left">
                Belanja lebih hemat dengan harga yang jujur. Regar Mart selalu menawarkan pilihan terbaik agar kebutuhan Anda terpenuhi tanpa menguras kantong.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            <div class="w-full h-48 overflow-hidden">
              <img src="/keunggulan.png" alt="Innovative & User Centric Technology"
                class="h-full w-full object-cover">
            </div>
            <div class="px-5 py-6 sm:px-9 sm:py-8 flex flex-col flex-grow">
              <h3 class="font-extrabold mb-3 text-[#26A81D] text-left text-base sm:text-lg">
              ...
              <p class="text-[13px] sm:text-[14px] text-gray-700 text-left">
                Semua kebutuhan harian tersedia dengan kualitas terbaik. Produk dipilih secara teliti agar pengalaman belanja Anda selalu nyaman, aman, dan memuaskan.
              </p>
            </div>
          </div>
          ...
          <div
            class="bg-white shadow-lg overflow-hidden flex flex-col rounded-[12px] transition duration-400 ease-in-out hover:shadow-2xl hover:-translate-y-2">
            <div class="w-full h-48 overflow-hidden">
              <img src="/keunggulan.png" alt="Market Potential & Growth Opportunity"
                class="h-full w-full object-cover">
            </div>
            <div class="px-5 py-6 sm:px-9 sm:py-8 flex flex-col flex-grow">
              <h3 class="font-extrabold mb-3 text-[#26A81D] text-left text-base sm:text-lg">
              ...
              <p class="text-[13px] sm:text-[14px] text-gray-700 text-left">
                Nikmati pengalaman belanja praktis dengan layanan sigap. Pengiriman cepat dan sistem terpercaya menjadikan Regar Mart selalu ada saat Anda butuh.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-3 sm:space-y-4">
          ...
          >
            ...
            <transition
              ...
              @leave="leave"
            >
              <div v-show="activeIndex === index" class="px-4 pb-4 sm:px-6 sm:pb-6 pt-0">
...
<script>
import { fetchCategories, fetchUnits } from '@/services/productService'; // Sesuaikan path jika perlu
...
export default {
  ...
  data() {
    return {
      ...
      faqData: [
        // Data FAQ tetap
        { question: "Apa jenis produk yang dijual?", answer: "Kami menjual berbagai jenis sayuran segar dan sembako berkualitas untuk memenuhi kebutuhan pokok sehari-hari." },
        { question: "Apakah ada layanan pengiriman?", answer: "Ya, kami menyediakan layanan pengiriman untuk area [wilayah/lokasi] dengan biaya yang kompetitif." },
        { question: "Bagaimana cara melakukan pemesanan?", answer: "Anda bisa melakukan pemesanan melalui website kami, atau langsung datang ke toko kami." },
        { question: "Apakah produk yang dijual berkualitas?", answer: "Ya, kami hanya menjual produk segar dan berkualitas dari supplier terpercaya." },
        { question: "Bagaimana jika produk yang diterima rusak atau tidak sesuai?", answer: "Kami menerima pengembalian atau penggantian produk jika ada kerusakan atau ketidaksesuaian. Silakan hubungi kami dalam waktu [batas waktu] untuk proses lebih lanjut." },
        { question: "Apakah ada promo atau diskon?", answer: "Ya, kami sering mengadakan promo dan diskon untuk produk tertentu. Pantau terus media sosial kami untuk informasi terbaru." }
      ],
      ...
      selectedUnit: '',     // ID Satuan Produk yang dipilih
    };
  },
  async mounted() {
    // Ambil data kategori dan satuan saat komponen dimuat
  ...
  methods: {
    ...
    async loadFilterData() {
      try {
        ...
        // Karena API Units mengembalikan list, dan di frontend dikelompokkan (Pcs/Butir/Buah, Bundling, Karton/Box), 
        // saya asumsikan unit API mengembalikan ID dan Name yang sesuai dengan pengelompokan di UI.
        // Jika tidak, Anda perlu menyesuaikan pemetaan (mapping) data di `productService.js` atau di sini.
        this.units = fetchedUnits; 
    ...
    /**
     * Mengarahkan ke halaman Katalog.vue dengan Query Parameters
     */
    searchProducts() {
      const queryParams = {};
      ...
      if (this.selectedUnit) {
        // Karena `productService.js` mengharapkan unit sebagai array string, kita sesuaikan.
        // Jika selectedUnit adalah ID tunggal, kita kirimkan. 
        // Katalog.vue perlu menangani ini.
        queryParams.unit = this.selectedUnit; 
      }
      
      // Menggunakan Vue Router untuk navigasi ke route 'katalog'
      // Anda harus memiliki route dengan nama 'katalog' terdaftar di router Anda.
      this.$router.push({ 
        name: 'Katalog', // Ganti dengan nama route katalog Anda
        query: queryParams
      }).catch(err => {
        // Menangani navigasi yang gagal atau duplikat
