              ...
              <div class="bg-white rounded-xl shadow-md p-4 max-w-lg mx-auto">
                ...
                <div class="mb-4">
                  ...
                  <div class="relative">
                    ...
                    <select v-else-if="error" disabled
...
const fetchFaqs = async () => {
  ...
  try {
    ...
    error.value = err.message || 'Terjadi kesalahan tidak terduga saat mengambil data.';
  } finally {
    isLoading.value = false;
  }
};
