  ...
  <div class="fixed top-0 w-full z-50">
        ...
        <div class="flex items-center">
            ...
            <div class="relative" ref="dropdownRef">
                ...
                <button 
                  ...
                  aria-haspopup="true"
                >
                  <svg class="w-4 h-4 mr-1 sm:mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <button 
              ...
              class="btn-toggle md:hidden ml-2 flex flex-col items-center justify-center 
    ...
    >
      <ul class="flex flex-col space-y-3 text-sm font-medium text-gray-700 w-full text-center">
        <li>
          <RouterLink to="/" class="mobile-nav-link" active-class="mobile-active-link" @click="closeMobileMenu">Beranda</RouterLink>
        </li>
        <li>
          <RouterLink to="/katalog" class="mobile-nav-link" active-class="mobile-active-link" @click="closeMobileMenu">Katalog</RouterLink>
        </li>
        <li>
          <RouterLink to="/tentang" class="mobile-nav-link" active-class="mobile-active-link" @click="closeMobileMenu">Tentang Kami</RouterLink>
        </li>
        <li>
          <RouterLink to="/testimoni" class="mobile-nav-link" active-class="mobile-active-link" @click="closeMobileMenu">Testimoni</RouterLink>
        </li>
      </ul>
    </div>
  </div>
